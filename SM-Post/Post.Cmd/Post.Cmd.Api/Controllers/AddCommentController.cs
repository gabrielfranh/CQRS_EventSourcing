...
namespace Post.Cmd.Api.Controllers
{
    ...
    public class AddCommentController(ICommandDispatcher commandDispatcher, ILogger<AddCommentController> logger) : ControllerBase
    {
        ...
        public async Task<ActionResult> AddCommentAsync(Guid id, AddCommentCommand command)
        {
            try
            {
                ...
                {
                    Message = "Add comment request completed sucessully!"
                });
            }
